...
Renderer.prototype.loadPlayerBodyModel = function()
{
	...
	var vertices = [
		...
		// Top
		0.30, -0.125, 1.45, 44/64, 16/32, 1, 1, 1, 1,
		0.55, -0.125, 1.45, 48/64, 16/32, 1, 1, 1, 1,
		0.55, 0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		0.55, 0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		0.30, 0.125, 1.45, 44/64, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 1.45, 44/64, 16/32, 1, 1, 1, 1,
		
		// Bottom
		0.30, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,
		0.30, 0.125, 0.73, 28/64, 20/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		0.55, -0.125, 0.73, 36/64, 16/32, 1, 1, 1, 1,
		0.30, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,
		
		// Front		
		0.30, -0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 0.73, 48/64, 32/32, 1, 1, 1, 1,
		0.55, -0.125, 0.73, 44/64, 32/32, 1, 1, 1, 1,
		0.55, -0.125, 0.73, 44/64, 32/32, 1, 1, 1, 1,
		0.55, -0.125, 1.45, 44/64, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		
		// Rear		
		0.30, 0.125, 1.45, 52/64, 20/32, 1, 1, 1, 1,
		0.55, 0.125, 1.45, 56/64, 20/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 56/64, 32/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 56/64, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 0.73, 52/64, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 1.45, 52/64, 20/32, 1, 1, 1, 1,
		...
		0.55, -0.125, 1.45, 44/64, 20/32, 1, 1, 1, 1,
		0.55, -0.125, 0.73, 44/64, 32/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 40/64, 32/32, 1, 1, 1, 1,
		0.55, 0.125, 0.73, 40/64, 32/32, 1, 1, 1, 1,
		0.55, 0.125, 1.45, 40/64, 20/32, 1, 1, 1, 1,
		0.55, -0.125, 1.45, 44/64, 20/32, 1, 1, 1, 1,
		
		// Right arm
		
		// Top
		-0.55, -0.125, 1.45, 44/64, 16/32, 1, 1, 1, 1,
		-0.30, -0.125, 1.45, 48/64, 16/32, 1, 1, 1, 1,
		-0.30, 0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		-0.30, 0.125, 1.45, 48/64, 20/32, 1, 1, 1, 1,
		-0.55, 0.125, 1.45, 44/64, 20/32, 1, 1, 1, 1,
		-0.55, -0.125, 1.45, 44/64, 16/32, 1, 1, 1, 1,
		...
		// Bottom
		-0.55, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,
		-0.55, 0.125, 0.73, 28/64, 20/32, 1, 1, 1, 1,
		-0.30, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		-0.30, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		-0.30, -0.125, 0.73, 36/64, 16/32, 1, 1, 1, 1,
		-0.55, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,
		...
		// Top
		0.01, -0.125, 0.73, 4/64, 16/32, 1, 1, 1, 1,
		0.30, -0.125, 0.73, 8/64, 16/32, 1, 1, 1, 1,
		0.30, 0.125, 0.73, 8/64, 20/32, 1, 1, 1, 1,
		0.30, 0.125, 0.73, 8/64, 20/32, 1, 1, 1, 1,
		0.01, 0.125, 0.73, 4/64, 20/32, 1, 1, 1, 1,
		0.01, -0.125, 0.73, 4/64, 16/32, 1, 1, 1, 1,
		
		// Bottom
		0.01, -0.125, 0, 28/64, 16/32, 1, 1, 1, 1,
		0.01, 0.125, 0, 28/64, 20/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 36/64, 20/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 36/64, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 0, 36/64, 16/32, 1, 1, 1, 1,
		0.01, -0.125, 0, 28/64, 16/32, 1, 1, 1, 1,
		
		// Front		
		0.01, -0.125, 0.73, 4/64, 20/32, 1, 1, 1, 1,
		0.01, -0.125, 0, 4/64, 32/32, 1, 1, 1, 1,
		0.30, -0.125, 0, 8/64, 32/32, 1, 1, 1, 1,
		0.30, -0.125, 0, 8/64, 32/32, 1, 1, 1, 1,
		0.30, -0.125, 0.73, 8/64, 20/32, 1, 1, 1, 1,
		0.01, -0.125, 0.73, 4/64, 20/32, 1, 1, 1, 1,
		...
		0.30, 0.125, 0.73, 16/64, 20/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 16/64, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 16/64, 32/32, 1, 1, 1, 1,
		0.01, 0.125, 0, 12/64, 32/32, 1, 1, 1, 1,
		0.01, 0.125, 0.73, 12/64, 20/32, 1, 1, 1, 1,
		...
		0.01, 0.125, 0, 12/64, 32/32, 1, 1, 1, 1,
		0.01, 0.125, 0, 12/64, 32/32, 1, 1, 1, 1,
		0.01, -0.125, 0, 8/64, 32/32, 1, 1, 1, 1,
		0.01, -0.125, 0.73, 8/64, 20/32, 1, 1, 1, 1,
		
		// Left
		0.30, -0.125, 0.73, 4/64, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 0, 4/64, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 0, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 0, 0, 32/32, 1, 1, 1, 1,
		0.30, 0.125, 0.73, 0, 20/32, 1, 1, 1, 1,
		0.30, -0.125, 0.73, 4/64, 20/32, 1, 1, 1, 1,
		
		// Right leg
		
		// Top
		-0.30, -0.125, 0.73, 4/64, 16/32, 1, 1, 1, 1,
		...
		// Bottom
		-0.30, -0.125, 0, 28/64, 16/32, 1, 1, 1, 1,
		-0.30, 0.125, 0, 28/64, 20/32, 1, 1, 1, 1,
		-0.01, 0.125, 0, 36/64, 20/32, 1, 1, 1, 1,
		-0.01, 0.125, 0, 36/64, 20/32, 1, 1, 1, 1,
		-0.01, -0.125, 0, 36/64, 16/32, 1, 1, 1, 1,
		-0.30, -0.125, 0, 28/64, 16/32, 1, 1, 1, 1,
